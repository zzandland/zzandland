...
export default ({ title, client, startDate, endDate, usedTech, link }) => (
  <div className="col s12 l6 xl6 section-padding">
    ...
    <ul className="project-details second-font">
      ...
      <li><i className="far fa-calendar"></i><span className="font-weight-700"> Start Date </span>: <span className="font-weight-400 uppercase">{moment(startDate).format('MM/DD/YYYY')}</span></li>
      {endDate ?
          <li><i className="far fa-calendar-check"></i><span className="font-weight-700"> End Date </span>: <span className="font-weight-400 uppercase">{moment(endDate).format('MM/DD/YYYY')}</span></li>
        : null
      }
